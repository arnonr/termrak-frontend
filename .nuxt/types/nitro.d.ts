...
declare module 'nitropack' {
  ...
  interface InternalApi {
    '/api/lang': Awaited<ReturnType<typeof import('../../server/api/lang').default>>
...
declare global {
  ...
  const cachedEventHandler: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/Applications/MAMP/htdocs/sicc/sicc-frontend/node_modules/nitropack/dist/runtime')['useStorage']
