<template>
        ...
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            <div class="breadcrumb__list">
              ...
              <span class="dvdr"><i class="fa-solid fa-circle-small"></i></span>
              <span>
                <NuxtLink href="/admin/services"> รายการบริการ </NuxtLink></span
              >
            </div>
          </div>
        </div>
  ...
  <section class="portfolio__area pt-40 pb-40">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h4>แบบฟอร์มเพิ่มข้อมูลบริการ</h4>
        </div>
...
uppy.on("file-removed", (file, reason) => {
  if (file.meta.services_gallery_id != null) {
    $fetch(
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/services/",
  };
